...
public class Values {
	...
	public static String[][][][] CONJUGATION_VERBS = new String[][][][]{PRESENT_CONJUGATION, PERFECT_CONJUGATION, FUTURE_CONJUGATION, IMPERFECT_CONJUGATION, PLUPERFECT_CONJUGATION, FUTURE_PERFECT_CONJUGATION};
